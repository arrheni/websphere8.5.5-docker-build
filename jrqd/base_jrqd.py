...
cf_createJ2Cdata('APP___NB__DBUSER', 'APP___NB__DBUSER', 'NB_ZNAKQ#new')
cf_createJ2Cdata('jrqd', 'jrqd', 'jrqd_QAZX1357new')
cf_createJ2Cdata('common', 'common', 'common#1027new')

cf_createdatasource('BankDataSource', 'jdbc/BankDataSource', 'APP___NB__DBUSER', 'jdbc:oracle:thin:@10.1.96.16:1521/nbsdb')
cf_createdatasource('UdmpDataSource', 'jdbc/UdmpDataSource', 'jrqd', 'jdbc:oracle:thin:@10.1.96.16:1521/cipdb')
cf_createdatasource('UdmpCommonDataSource', 'jdbc/UdmpCommonDataSource', 'common', 'jdbc:oracle:thin:@10.1.96.16:1521/pasdb')
cf_createdatasource('UdmpJndiDataSource', 'jdbc/UdmpJndiDataSource', 'jrqd', 'jdbc:oracle:thin:@10.1.96.16:1521/cipdb')

cf_setjavaheapsize('30720', '30720')

cf_setwebcontainerthread('50', '350')

cf_setconnectionpool('BankDataSource', '10', '200')
cf_setconnectionpool('UdmpDataSource', '10', '200')
cf_setconnectionpool('UdmpCommonDataSource', '10', '200')
cf_setconnectionpool('UdmpJndiDataSource', '10', '200')
...
installApp('server1', 'local-webapp', '/tmp/jrqd.ear')
