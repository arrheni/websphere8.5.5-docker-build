...
cf_createdatasource('CSSJndiDataSource', 'jdbc/CSSJndiDataSource', 'APP__CSS__DBUSER', 'jdbc:oracle:thin:@10.1.96.16:1521/')
...
installApp('server1', 'local-webapp', '/tmp/local-webapp-0.5.5.5.war')
