...
cf_createJ2Cdata('APP___NB__DBUSER', 'APP___NB__DBUSER', '#')
cf_createJ2Cdata('jrqd', 'jrqd', '')
cf_createJ2Cdata('common', 'common', '#')

cf_createdatasource('NewJndiDataSource', 'jdbc/NewJndiDataSource', 'APP___NB__DBUSER', 'jdbc:oracle:thin:@10.1.96.16:1521/')
cf_createdatasource('UdmpJndiDataSource', 'jdbc/UdmpJndiDataSource', 'jrqd', 'jdbc:oracle:thin:@10.1.96.16:1521/')
...
cf_setconnectionpool('NewJndiDataSource', '10', '200')
...
installApp('server1', 'cip-web', '/tmp/cip.ear')

changeClassLoader('cip-web', 'PARENT_LAST', 'Application')
