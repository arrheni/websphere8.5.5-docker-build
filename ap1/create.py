...
def create():
        ...
        AdminTask.createAuthDataEntry('[-alias APP___PAS__DBUSER -user APP___PAS__DBUSER -password PAS_NAKDFQ#new -description ]')
        AdminTask.createAuthDataEntry('[-alias global1 -user global1 -password global1#1027new -description ]')
        AdminTask.createAuthDataEntry('[-alias common -user common -password common#1027new -description ]')
        AdminTask.createAuthDataEntry('[-alias APP___CSS__DBUSER -user APP___CSS__DBUSER -password CSS_9VK#7new  -description ]')
