...
cf_createJ2Cdata('udmp', 'udmp', '#')
cf_createJ2Cdata('common', 'common', '#')

cf_createdatasource('UdmpBatchDataSource', 'jdbc/UdmpBatchDataSource', 'udmp', 'jdbc:oracle:thin:@10.1.96.16:1521/')
cf_createdatasource('UdmpJndiDataSource', 'jdbc/UdmpJndiDataSource', 'udmp', 'jdbc:oracle:thin:@10.1.96.16:1521/')
...
cf_setconnectionpool('UdmpBatchDataSource', '10', '200')
...
installApp('server1', 'batch-war', '/tmp/batch.ear')

changeClassLoader('batch_war', 'PARENT_LAST', 'Application')
