...
cf_createdatasource('UdmpDataSource', 'jdbc/UdmpDataSource', 'global1', 'jdbc:oracle:thin:@10.1.96.16:1521/')
cf_createdatasource('UdmpJndiDataSource', 'jdbc/UdmpJndiDataSource', 'global1', 'jdbc:oracle:thin:@10.1.96.16:1521/')
...
installApp('server1', 'local-webapp', '/tmp/nb.ear')
