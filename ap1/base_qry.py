...
cf_createJ2Cdata('query', 'query', '')
cf_createJ2Cdata('common', 'common', '#')

cf_createdatasource('UdmpDataSource', 'jdbc/UdmpDataSource', 'query', 'jdbc:oracle:thin:@10.1.96.15:1521/')
cf_createdatasource('UdmpJndiDataSource', 'jdbc/UdmpJndiDataSource', 'query', 'jdbc:oracle:thin:@10.1.96.15:1521/')
cf_createdatasource('UdmpCommonDataSource', 'jdbc/UdmpCommonDataSource', 'common', 'jdbc:oracle:thin:@10.1.96.15:1521/')
...
installApp('server1', 'qry-web', '/tmp/qry.ear')

changeClassLoader('qry-web', 'PARENT_LAST', 'Application')
